...
void motorSwitch() {
  ...
  while(counter < 500) {
    ...
    if (switchState2 == HIGH && directionSwitched2 == false) {
      // turn LED on:
      digitalWrite(ledPin2, HIGH);
      directionSwitched2 = true;
      switchDirection();
      Serial.println("Switch 2 turned on");
  
    } else if (switchState2 == LOW && directionSwitched2 == true) {
      // turn LED off:
      digitalWrite(ledPin2, LOW);
      directionSwitched2 = false;
